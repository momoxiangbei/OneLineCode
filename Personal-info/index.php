<?php
	...
	$sql="select * from codes where code like '%{$search}%' and uid=$uid";
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="#">我的代码库</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="deelLogout.php"><i class="glyphicon glyphicon-log-out"></i></a></li>
					<li class="dropdown">
			...
			<table class="table table-bordered table-striped table-hover">
				...
				?>
					<tr id="code">
						...
						<td ><a href="change.php?id=<?php echo $codes['id']?>" class="btn btn-primary">修改</a>
							<a href="deelDelete.php?id=<?php echo $codes['id']?>" class="btn btn-warning">删除</a>
						</td>
					</tr>
					<tr id="note">
						<td ><xmp >
