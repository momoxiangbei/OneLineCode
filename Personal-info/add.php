...
<body>
	...
	<div class="content">
		<div class="content-add">
			...
			<form role="form" action="deelAdd.php" method="post">
				<div class="form-group">
					<label for="exampleInputCode">代码区</label>
					<input type="text" class="form-control" id="exampleInputCode"  name="code">
				</div>
				<div class="form-group">
					<label for="exampleInputNote">注释区</label>
					<input type="text" class="form-control" id="exampleInputNote"  name="node">
				</div>
